...
urlpatterns = [
    ...
    path('student_BarcodeScan', StudentViews.student_BarcodeScan, name="student_BarcodeScan"),
    path('verify-barcode/', StudentViews.verify_barcode_view, name='verify-barcode'),
    # path('save_student_attendance/', StudentViews.save_student_attendance,name='save_student_attendance'),
