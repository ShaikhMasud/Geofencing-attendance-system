...
class CustomUser(AbstractUser):
    ...
    barcode_number = models.CharField(max_length=50, default='')  # Add the barcode number field
...
class Students(models.Model):
    ...
    session_year_id = models.ForeignKey(SessionYearModel, on_delete=models.DO_NOTHING, default=1)  # Provide a default value here
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now_add=True)
    fcm_token=models.TextField(default="")
    objects = models.Manager()
...
class Attendance(models.Model):
    ...
    session_year_id=models.ForeignKey(SessionYearModel,on_delete=models.CASCADE, default=1)  # Provide a default value here
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now_add=True)
    objects = models.Manager()
